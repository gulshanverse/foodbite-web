...
CREATE TABLE "Reservation" ("id" UUID NOT NULL,"userId" UUID NOT NULL,"listingId" UUID NOT NULL,"quantity" INTEGER NOT NULL,"status" "ReservationStatus" NOT NULL DEFAULT 'ACTIVE',"expiresAt" TIMESTAMP(3) NOT NULL,"createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,"updatedAt" TIMESTAMP(3) NOT NULL,CONSTRAINT "Reservation_pkey" PRIMARY KEY ("id"));
...
CREATE TABLE "Order" ("id" UUID NOT NULL,"orderNumber" TEXT NOT NULL,"buyerId" UUID NOT NULL,"status" "OrderStatus" NOT NULL DEFAULT 'PENDING_PAYMENT',"subtotal" INTEGER NOT NULL,"totalAmount" INTEGER NOT NULL,"currency" TEXT NOT NULL DEFAULT 'INR',"buyerName" TEXT NOT NULL,"buyerPhone" TEXT,"pickupAddress" TEXT,"pickupCity" TEXT,"pickupPincode" TEXT,"createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,"updatedAt" TIMESTAMP(3) NOT NULL,"paidAt" TIMESTAMP(3),"cancelledAt" TIMESTAMP(3),"completedAt" TIMESTAMP(3),"reservationId" UUID,CONSTRAINT "Order_pkey" PRIMARY KEY ("id"));
