...
export async function POST(request: Request) {
  ...
  void notifyOrderEvent(parsed.data.orderId, "ORDER_PICKED_UP").catch((error) => log("error", "notification_dispatch_failed", { orderId: parsed.data.orderId, type: "ORDER_PICKED_UP", category: safeErrorCategory(error) }));
